                        ...
                        <div className="space-y-12 border-l border-white/10 ml-3 pl-8 relative">
                            ...
                            <div className="group relative">
                                ...
                                <p className="text-base text-neutral-300 max-w-md leading-relaxed transition-all duration-300 group-hover:text-neutral-100">
                                    Me dedico al desarrollo backend dentro de mi emprendimiento Chacú.IO, donde lidero la creación de soluciones tecnológicas para clientes de diversos sectores.
                                </p>
                            </div>
                            ...
                            <div className="group relative">
                                ...
                                <p className="text-base text-neutral-300 max-w-md leading-relaxed transition-all duration-300 group-hover:text-neutral-100">
                                    Desarrollé aplicaciones web a medida de acuerdo a las necesidades de mis clientes, abarcando tanto la lógica de negocio y del servidor como la interfaz de usuario y la integración con servicios externos. 
                                </p>
                            </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-12 border-l border-white/10 ml-3 pl-8 relative">
                            ...
                            <div className="group relative">
                                ...
                                <p className="text-sm text-primary mb-1 font-semibold tracking-wide">2024 - 2025 | Finalizado</p>
                                ...
                                <p className="text-base text-neutral-300 max-w-md leading-relaxed transition-all duration-300 group-hover:text-neutral-100">
                                    Formación en arquitectura de software, análisis de requerimientos, desarrollo y testing de aplicaciones web y móviles. 
                                </p>
                            </div>
